...
const Navbar = () => {
    ...
    useEffect(()=>{
      if(query===""){
        ...
        let newsuggestions=country.filter((item)=>{
  ...
  return (
    <Flex width={[100,100,100,]}  alignItems={"right"}  direction={"column"}  gap='2'>
        <Flex h={["1rem","1.5rem","2rem"]} display="flex" justifyContent={"flex-end"} w='100%' bg="red">
     ...
     <Spacer />
      ...
      md: '2rem', // 48em-80em,
      xl: '4rem', // 80em+
    }} display="flex" w='100%' justifyContent={"space-between"} direction="row" bg="red">
