...
const Footers = () => {
  return (
    <Box w={["100%","100%","100%","100%"]} bg="#cfcfcf" pt={"100px"}>
...
<SimpleGrid  columns={[2,2,2,4]}  spacing={15} w={["90%","90%","90%","90%"]} m="auto" mt={"30px"}>
    <Box  textAlign={"left"} p={"5px 5px"} h="auto" display={"flex"} flexDirection="column" justifyContent={"space-between"}>
    <h1 className='heading'>Company Information</h1>
               ...
               <a href="">Contat us</a>
               <a href="">Report Secuirity issue</a>
               <a href="">Sell on Gearbest</a>
               <a href="">Cookies Policy</a>
               <a href="">Top Brands</a>
               <a href="">Gearbest offical Blogs</a>
    </Box>
    <Box p={"5px 5px"} textAlign={"left"} h="fit-content">
                 <h1 className='heading'>Customer Service</h1>
                <a href="">Shopping Information</a>
                <a href="">My favirates</a>
                <a href="">FAQ</a>
                <a href="">My Points</a>
                <a href="">Warrenty and Rerturns</a>
                <a href="">Payments Methods</a>
                <a href="">Deposite Expansion</a>
                <a href="">Support</a>
                <a href="">Sitemap</a>
                <a href="">Gearbest Wallet Informaion</a>
                <a href="">aboute COVID-19</a>


    </Box>
    <Box p={"5px 5px"} textAlign={"left"} >
...
<SimpleGrid  columns={[6,6,12,23]}  spacing={15} w={["90%","90%","90%","90%"]} m="auto" mt={"30px"}>
...
<Box  w={["100%","100%","100%","100%"]} bg="black" h="80px" textAlign={"center"}color="white">
